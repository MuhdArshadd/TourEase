...
import '../Controller/security_questions.dart'; // import controller security
...
class _RegisterBusinessPageState extends State<RegisterBusinessPage> {
  ...
  String? _businessNameError; // For validation error
  String? _emailError;
  ...
  void dispose() {
    ...
    _businessNameController.dispose(); // Clean up the controller when done
  ...
  Future<void> _register() async {
    ...
    if (isValid) {
      ...
      final int category = 0; //0 is for business
